...
const TeamPage = () => {
    const notice = `
        ...
        <br/><br/>
        We urge everyone to exercise caution and verify any communications that appear to come from Being Diplomatic to confirm their authenticity.
        <br/><br/>
        <b>Being Diplomatic does not charge any fees from job seekers at any stage of the recruitment process.</b> We do not authorize any individual or entity to request payments or make financial arrangements in exchange for employment opportunities.
        <br/><br/>
        All official communication from Being Diplomatic's human resources or recruitment teams will come from email addresses that use the domain <b>[Being Diplomatic.COM]</b>. If you receive communication from any other domain or generic email services such as Gmail or Yahoo regarding job offers or interviews, please proceed with caution, as this is likely a scam.
        <br/><br/>
            ...
            <div className='container rounded-2 my-5' style={{ background: '#034EA2' }}>
                <div className='row py-5 px-2'>
                    ...
                    <div className='text-light'>
                        Ready to elevate your brand’s digital presence? Contact Being Diplomatic today to discover how we can help you achieve your business goals. Whether you need a detailed consultation or just want to learn more about our services, we’re here to assist.
                    </div>
